...
// CONSTANTES
const string RobotHeadDriver::POINT_HEAD_CONTROLLER = "/head_traj_controller/point_head_action";
const float RobotHeadDriver::HEAD_MAX_VELOCITY = 0.8;
const float RobotHeadDriver::HEAD_MIN_DURATION = 0.1;
const float RobotHeadDriver::HEAD_TIMEOUT = 15;
...
RobotHeadDriver::RobotHeadDriver(){
    ...
    ROS_DEBUG("RobotHeadDriver: Esperando servicio por %f s", WAIT_CONTROLLER_TIMEOUT);
